...
$(document).ready(function() {
    ...
    $(function() {
       ...
       $("#register-form").validate({
            ...
            messages:{
                ...
                agree:"Merci d'accepter les conditions d'utilisation"
            },
            
            submitHandler:function(form) {
                $(form).ajaxSubmit({
                    beforeSend:function() {
                        $("button[name=submit]").html("Envoi...");
                    },
                    success:function(responseText, statusText, xhr, $form) {
                        $("#email, button[name=submit]").fadeOut('slow', function(){
                            $(this).remove();
                            $(".form-group").html(responseText);
                        });                        
                    }
                });
	...
	//Google Maps
	$('#about-us').on("shown.bs.modal", function(e) {
		if (!olympus.maps_created) {
			setTimeout(function() {
				googleMaps();
				olympus.maps_created = true;
			}, 500);
		}
	});
